...
function App() {
  return (
    <>
      <Header linkHeader={"../public/logo-books.jpg"} link1="Home" link2="Sobre Nosotros" link3="Productos" />
      <main>
        <Hero heroTitle="Bienvenido a Best Books" heroText="Te traemos tus libros preferidos a los mejores precios del mercado, para que nos creas estaria bueno que cheques nuestros productos y los precios que tenemos, espero disfrutes de los productos y la pagina web." heroLink="Productos" heroImg="../public//hero-img.jpg" />
